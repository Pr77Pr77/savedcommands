...
public class ShareStatusScreen extends PopupScreen {
    ...
    protected void init() {
        ...
        this.closeButton = Button.builder(Component.translatable("gui.cancel"), _ -> exit()).bounds((this.width - 100) / 2, popupY + popupH - 20 - 10, 100, 20).build();
    ...
    private static class ShareStatusList extends ContainerObjectSelectionList<ShareStatusList.PlayerEntry> {
        ...
        public class PlayerEntry extends Entry<ShareStatusList.PlayerEntry> {
            ...
            public void extractContent(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
                ...
                graphics.text(minecraft.font, player.getKey().getProfile().name(), getContentX() + 4 + 24 + 4, getContentY() + (getContentHeight() - 8) / 2, 0xFFFFFFFF);

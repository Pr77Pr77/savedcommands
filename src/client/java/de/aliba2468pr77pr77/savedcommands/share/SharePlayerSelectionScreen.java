...
public class SharePlayerSelectionScreen extends PopupScreen {
    ...
    protected void init() {
        ...
        this.selectMoreCommandsButton = Button.builder(Component.translatable("screen.savedcommands.share.selectmorecommands"), button -> exit(exitTypes.SELECT_MORE_COMMANDS)).bounds(popupX + popupW - 135 - 10, popupY + 22, 135, 20).build();
        ...
        this.sendButton = Button.builder(Component.translatable("screen.savedcommands.send"), button -> exit(exitTypes.SEND)).bounds(popupX + (popupW - 100 - 5 - 100) / 2, popupY + popupH - 20 - 10, 100, 20).build();

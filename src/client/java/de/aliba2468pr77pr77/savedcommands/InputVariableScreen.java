...
public class InputVariableScreen extends PopupScreen {
    ...
    protected void init() {
        ...
        this.cancelButton = Button.builder(Component.translatable("gui.cancel"), _ -> exit()).bounds(popupX + (popupW - 100 + 100 + 5) / 2, popupY + popupH - 20 - 20, 100, 20).build();
        this.addRenderableWidget(this.cancelButton);

        this.doneButton = Button.builder(Component.translatable("screen.savedcommands.send"), _ -> exit(true)).bounds(popupX + (popupW - 100 - 100 - 5) / 2, popupY + popupH - 20 - 20, 100, 20).build();
